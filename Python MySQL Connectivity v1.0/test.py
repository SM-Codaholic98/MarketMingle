'''1. function for database creation
2. function for table creation
3. add more columns with various data types in the table
4. create another table and add primary key & foreign key'''
...
con = mysql.connector.connect(
	host="localhost", user="root", password="piku@2004", database="emp")
